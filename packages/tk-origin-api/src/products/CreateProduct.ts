export const CREATE_PRODUCT_URL_PATH = '/product/202309/products';,export const CREATE_PRODUCT_METHOD = '1';


/**
 * 接口名称：Create Product
 * 接口标识：Create Product
 * 接口使用场景：Create Product
 **/
export interface CreateProductRequestInterface {
  /**
   * @description: save_mode is used to specify the saving mode for creating a product, supporting **AS_DRAFT**, **LISTING**.<br>**Notice：**<br>Without passing the "save mode" parameter, the default value is "LISTING".
   * @type: string
   **/
  save_mode?: string;

  /**
   * @description: HTML rich text of a product description to describe your product information in detail.<br><br>**Prerequisites:**<br>- Must conform to html syntax<br>- Currently, it only supports html tags \\<p\\> \\<img\\> \\<ul\\> \\<ol\\> \\<li\\> \\<br\\> \\<strong\\> \\<b\\> \\<i\\> \\<em\\> \\<u\\>, other HTML tags will be filtered out and will not take effect. <br>- Tags can not be nested<br>- This field character limit needs to be within 10000 characters.<br>- It is recommended to avoid using Chinese because the copy will be displayed to local users.<br>- The img tag needs to include the src, width, and height attributes, and the image dimensions can not exceed 4000<br>- Only Tiktok Shop image URLs are allowed, no external URLs.<br>- \\<strong\\> \\<b\\> \\<i\\> \\<em\\> \\<u\\> \\<br\\> should be used within  \\<p\\> and \\<li\\><br><br>**Tips**<br>- Please provide a clear and comprehensive product description preferably longer than 300 characters, and adding images to the description will help customers make purchasing decisions.<br>- We recommend publishing 3 to 5 selling points. Different selling points are described in segments and a single selling point is within 250 characters to increase the readability of consumers.<br>**Sample**<br>\\<p\\>Please compare above detailed size with your measurement before purchase.\\<\\/p\\><br>\\<ul\\> <br>  \\<li\\>M-Size\\<\\/li\\><br>  \\<li\\>XL-Size\\<\\/li\\><br>\\<\\/ul\\> <br>\\<img src="https://p16-oec-va.ibyteimg.com/tos-maliva-i-o3syd03w52-us/181595ea7d26489284b5667488d708c1~tplv-o3syd03w52-origin-jpeg.jpeg?from=1432613627" width='100' height='100' \\/\\>
   * @type: string
   **/
  description: string;

  /**
   * @description: The product category must be a Leaf Category, which is the lowest level of category. Leaf Categories are a category which has no sub categories under it. If you do not use a Leaf Category, your Create Product call will be rejected.<br>i.e US market in [Restricted and Unsupported Products Guidelines](https://seller-us.tiktok.com/university/essay?identity=1&role=1&knowledge_id=3238037484275457&from=policy)
   * @type: string
   **/
  category_id: string;
  ...
  /**
   * @description: The product skus contain sales attributes, inventory, price, identifier code and other information.<br>**Prerequisites:**<br>- The number of SKUs in the US market and UK market should not exceed 100, while the number of SKUs in other markets should not exceed 300.
   * @type: []object
   **/
  skus: []object;

  /**
   * @description: The name of product.<br>**Prerequisites:**<br>- Chinese characters are not allowed in the product title. <br>- For US and UK shops, the product name must have at least 1 character and no more than 255 characters. <br>- For shops in other regions, the product name must have at least 25 characters and no more than 255 characters.
   * @type: string
   **/
  title: string;

  /**
   * @description: COD stands for Cash On Delivery, which is allowed by certain categories. You can check if your category allows COD through the 'GetCategoryRule' API. <br>Set is_cod_allowed to be true if unsupported regions or categories are intercepted. If enabled, buyers can choose this payment method during checkout.
   * @type: bool
   **/
  is_cod_allowed?: bool;
 ...
 * @description You can only use the response parameters of the "Upload Image" API as the request parameters. <br>**Prerequisites**<br>- Upload 1 to 9 images in png, jpg or jpeg format with file size not more than 5 MB.<br>- The order of image arraylist will become the sequence of images. <br>- The resolution of the image should not be lower than 300*300px, and not higher than 4000px*4000px<br>- Use a language acceptable to the marketplace if need text.<br>**Tips**<br>- The main body of the product is clear. Please display your product as comprehensively as possible, and it is recommended that there be no less than 5 images.<br>- We recommend using a white background image as the first image,notamosaic containing psoriasis elements: text, logos, borders, color blocks, watermarks or other graphics.
 **/
export interface CreateProductMainImagesRequestInterface {
  /**
 ...
 * @description The product skus contain sales attributes, inventory, price, identifier code and other information.<br>**Prerequisites:**<br>- The number of SKUs in the US market and UK market should not exceed 100, while the number of SKUs in other markets should not exceed 300.
 **/
export interface CreateProductSkusRequestInterface {
  /**
 ...
 * @description **What are the sales attributes of Tiktok Shop?**<br>SKU(Stock Keeping Unit) contains sales attributes. Each SKU represents a specific product variant, and product variants are typically composed of multiple sales attributes. <br>Optionally fill in either the sales attribute ID or the sales attribute name. If both are filled, the ID will be prioritized.<br><br>**How to Use?**<br>You can obtain information about sales attributes through the "**Get Attributes**" API. The sales attribute information of SKU can not be duplicated. <br>If the structure is empty, it means that the product has no sales attribute.<br>**Tips**<br>- Capitalize the first letter of each word (except conjunctions, articles, prepositions) to customize the variation name.<br>- Set the most important variation as the first, and add SKU pictures, and add corresponding product pictures under different SKUs, instead of using the same picture.
 **/
export interface CreateProductSkusSalesAttributesRequestInterface {
  /**
   * @description: You can obtain the built-in sales attribute IDs through the GetAttributes API. 
   * @type: string
   **/
  ^^id?: string;
 ...
 * @description You can add an image to a sales attribute value, and the image will be displayed to the buyer.
 **/
export interface CreateProductSkusSalesAttributesSkuImgRequestInterface {
  /**
 ...
 * @description This is inventory information for SKU, including warehouse and corresponding inventory quantity.
 **/
export interface CreateProductSkusInventoryRequestInterface {
  /**
  ...
  /**
   * @description: The quantity value of stock must be a non-negative number, and the upper limit of inventory value set at one time is 999999.
   * @type: int
   **/
  ^^quantity?: int;
}
 ...
 * @description The price of the SKU, whether it is for cross-border or domestic, should be provided as the pre-tax price of the product.
 **/
export interface CreateProductSkusPriceRequestInterface {
  /**
 ...
 * @description If the SKU has a unique identifier code, it can be filled in here.
 **/
export interface CreateProductSkusIdentifierCodeRequestInterface {
  /**
 ...
 * @description For a combined listing SKU, an array of related product SKUs that compose the combined listing SKU.
 **/
export interface CreateProductSkusCombinedSkusRequestInterface {
  /**
 ...
 * @description Based on the category your product belongs to, your product may require product certification. You can obtain the requirements for each category via the "**Get Category Rule**" API. <br>Refers to certain types of products that require prior approval from TikTok Shop to be sold. Sellers who wish to sell restricted products may be required to pass a category approval process before selling such products. <br>i.e US market in [Restricted and Unsupported Products Guidelines](https://seller-us.tiktok.com/university/essay?identity=1&role=1&knowledge_id=3238037484275457&from=policy)
 **/
export interface CreateProductCertificationsRequestInterface {
  /**
  ...
  /**
   * @description: The dimensions of the product package may affect the shipping cost and logistics accessibility. Please fill in the accurate information<br><br>**Tips**<br>- Enter the product dimensions after it is packaged to calculate the shipping fee based on the dimensions (i.e. volume weight).<br>- If there is a difference between the dimension entered and the actual dimension, you may be required to make up the difference.
   * @type: object
   **/
  package_dimensions?: object;

  /**
   * @description: **What are the product attributes of Tiktok Shop?**<br>Product attributes must be complete, accurate, and consistent with the product's name, description, and images on the listing page.<br><br>**How to Use?**<br>You can obtain information about product attributes through the "Get Attributes" API.
   * @type: []object
   **/
 ...
 * @description Specific category certification image information.
 **/
export interface CreateProductCertificationsImagesRequestInterface {
  /**
 ...
 * @description Specific category certification file information.
 **/
export interface CreateProductCertificationsFilesRequestInterface {
  /**
 ...
 * @description The dimensions of the product package may affect the shipping cost and logistics accessibility. Please fill in the accurate information<br><br>**Tips**<br>- Enter the product dimensions after it is packaged to calculate the shipping fee based on the dimensions (i.e. volume weight).<br>- If there is a difference between the dimension entered and the actual dimension, you may be required to make up the difference.
 **/
export interface CreateProductCertificationsPackageDimensionsRequestInterface {
  /**
 ...
 * @description **What are the product attributes of Tiktok Shop?**<br>Product attributes must be complete, accurate, and consistent with the product's name, description, and images on the listing page.<br><br>**How to Use?**<br>You can obtain information about product attributes through the "Get Attributes" API.
 **/
export interface CreateProductCertificationsProductAttributesRequestInterface {
  /**
  ...
  /**
   * @description: You can fill in the video information related to the product, and this video will be displayed to the buyer.<br><br>**Tips**<br>- The recommended ratio is 1:1 and recommended resolution is above HD 720p.<br>- We recommend the video duration is within 20s, and the longest should not exceed 60s.<br>- Try highlighting 1-2 core selling points for your product. This will be displayed in the product details section.
   * @type: object
   **/
  video?: object;
  ...
  /**
   * @description: This is an optional field. If you do not fill in this part of the information, the system will set this field as the "default" delivery option.<br>
   * @type: string[]
   **/
 ...
 * @description You can fill in the product attribute value information corresponding to the product attribute id.<br>Optionally fill in either the product attribute value ID or the product attribute value name. If both are filled, the product attribute value ID will be prioritized.
 **/
export interface CreateProductCertificationsProductAttributesValuesRequestInterface {
  /**
 ...
 * @description The weight of the product package may affect the shipping cost and logistics accessibility. It must be within the limited scope of the carriage.<br>- Please note that the unit of package_dimensions and the unit of package_weight must match. <br>- Currently, only "CENTIMETER"-"KILOGRAM" and "INCH"-"POUND" are supported.<br>**Tips**<br>- Enter the weight by weighing the product after it is packaged.<br>- If there is a difference between the weight entered and the actual weight, you may be required to make up the difference.<br>- If the estimated fee based on the weight is greater than the fee based on the dimensions, the product's weight will be used.<br>- TikTok weight calculation: weight * price per unit of weight
 **/
export interface CreateProductCertificationsProductAttributesPackageWeightRequestInterface {
  /**
 ...
 * @description You can fill in the video information related to the product, and this video will be displayed to the buyer.<br><br>**Tips**<br>- The recommended ratio is 1:1 and recommended resolution is above HD 720p.<br>- We recommend the video duration is within 20s, and the longest should not exceed 60s.<br>- Try highlighting 1-2 core selling points for your product. This will be displayed in the product details section.
 **/
export interface CreateProductCertificationsProductAttributesVideoRequestInterface {
  /**
 ...
 * @description **What is the size chart on Tiktok Shop？**<br>A size chart is a guide that helps individuals find the right size by providing measurements and corresponding sizes for different clothing or products.<br><br>**How to use It？**<br>- Whether the size chart is required and related to the category, and you can obtain size chart listing rules through the "Get Category Rule" API.<br>- You can choose to pass in the size chart image or the pre-generated size chart template ID. If both are filled, the size chart template ID will be prioritized.
 **/
export interface CreateProductCertificationsProductAttributesSizeChartRequestInterface {
  /**
   * @description: The size chart image
   * @type: object
   **/
  ^image?: object;
  ...
  /**
   * @description: If you pass in true, the created product is not for sale. Not-for-sale products are only available as gifts through the Gift with purchase tool. They cannot be purchased separately and won't appear in search or recommendations.
   * @type: bool
   **/
 ...
 * @description The size chart image
 **/
export interface CreateProductCertificationsProductAttributesSizeChartImageRequestInterface {
  /**
 ...
 * @description The size chart template generated by the size chart tool. This feature can be accessed by going to **Seller Center -> Batch Tools -> Batch Manage size chart**.
 **/
export interface CreateProductCertificationsProductAttributesSizeChartTemplateRequestInterface {
  /**
 ...
 * @description You can fill in the Manufacturer Information using this object, including the following fields
 **/
export interface CreateProductCertificationsProductAttributesSizeChartManufacturerRequestInterface {
  /**
  ...
  /**
   * @description: The email address of the manufacturer. <br>- Must be a valid email address, for example:<br>  xxx@xxx.xxx<br>- Must be filled with name, address and phone number to be valid
   * @type: string
   **/
  ^email?: string;
}
 ...
 * 接口使用场景：Create Product
 **/
export interface CreateProductResponseInterface {
  /**
 ...
 * @description Specific return information
 **/
export interface CreateProductDataResponseInterface {
  /**
 ...
 * @description SKU info
 **/
export interface CreateProductDataSkusResponseInterface {
  /**
 ...
 * @description If you have not filled in the sales attribute information, this structure will be  empty.
 **/
export interface CreateProductDataSkusSalesAttributesResponseInterface {
  /**
 ...
 * @description Warning level information that interface callers need to pay attention to.
 **/
export interface CreateProductDataWarningsResponseInterface {
  /**
   * @description: The information in the warning message needs to be especially paid attention to. Please modify the products in time according to the suggestions.
   * @type: string
   **/
  ^^message?: string;
}
