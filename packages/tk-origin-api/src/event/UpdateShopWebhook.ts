export const UPDATE_SHOP_WEBHOOK_URL_PATH = '/event/202309/webhooks';,export const UPDATE_SHOP_WEBHOOK_METHOD = '3';


/**
 * 接口名称：Update Shop Webhook
 * 接口标识：Update Shop Webhook
 * 接口使用场景：Update Shop Webhook
 **/
export interface UpdateShopWebhookRequestInterface {
  /**
   * @description: The webhook URL used to receive http requests of the above event type. The maximum character is 255.<br>
   * @type: string
   **/
  address: string;
 ...
 * 接口使用场景：Update Shop Webhook
 **/
export interface UpdateShopWebhookResponseInterface {
  /**
